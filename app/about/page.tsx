            ...
            <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
                        <AnimatedElement animation="slideLeft" duration={700} threshold={0.2}>
                            <div>
                    ...
                    {/* Contact Section */}
                    <AnimatedElement animation="slideUp" duration={700} threshold={0.2}>
                        <div className="bg-muted/30 rounded-lg p-8 text-center card-hover">
                    ...
                    {/* Project Links */}
                    <StaggeredContainer className="mt-16 grid md:grid-cols-4 gap-6" itemDelay={120}>
                        <AnimatedCard>
                            <Card className="p-6 bg-card border-border hover:border-primary/50 transition-colors text-center card-hover">
